import 'package:clean_flutter_app/domain/helper/domain_error.dart';
...
void main() {
  ...
  test('Should not emit password error if validation succeed', () {
    sut.passwordErrorStream
  ...
  test('Should emit password error if password field validation fails', () {
  ...
  test('Should emit correct events on InvalidCredentialsErrors', () async {
